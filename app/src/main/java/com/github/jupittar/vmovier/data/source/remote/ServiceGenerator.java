...
import com.github.jupittar.vmovier.data.source.remote.interceptors.HttpCacheInterceptor;
...
public class ServiceGenerator {
    ...
    public static void init(Context context) {
        ...
        if (BuildConfig.DEBUG) {
            okHttpClientBuilder.addInterceptor(new com.github.jupittar.vmovier.data.source.remote.interceptors.HttpLoggingInterceptor());
        }
