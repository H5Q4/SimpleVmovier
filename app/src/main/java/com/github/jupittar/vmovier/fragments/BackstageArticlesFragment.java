...
public class BackstageArticlesFragment extends LazyFragment {
    ...
    public BackstageArticlesFragment() {
        // Required empty public constructor
    }

    public static BackstageArticlesFragment newInstance(String cateId) {
        BackstageArticlesFragment fragment = new BackstageArticlesFragment();
